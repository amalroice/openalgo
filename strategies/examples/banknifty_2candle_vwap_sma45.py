...
Entry (long; short is the mirror):
    ...
    4. No VIX floor since 2026-09-22 (VIX_MIN = None); only NIFTY keeps one.
...
#     before (trail)       +5,54,833   +2,45,449 PF 1.31   +2,22,935 PF 1.73   +42,261
#     full step + target     -48,719     +19,698 PF 1.02     +85,556 PF 1.24   +19,339
#     half step + target     -69,964     +14,431 PF 1.02   +1,06,977 PF 1.29   +18,234
#     half step (live)     +5,11,464   +2,31,126 PF 1.31   +2,28,069 PF 1.77   +42,261
#     full step            +3,33,995   +1,72,701 PF 1.22   +1,83,450 PF 1.57   +28,866
#
# Set STEP_TRAIL_PTS = None to restore the earlier exits.
# Reproduce: session 6c4a1f40 scratchpad half_step.py.
STEP_TRAIL_PTS = 40.0
STEP_TRAIL_MOVE_PTS = 20.0
...
# and briefly raised to 11 on 2026-09-22. Removed the same day (VIX_MIN = None)
